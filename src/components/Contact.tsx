...
export default function Contact() {
  ...
  return (
    <div className="bg-gray-50 dark:bg-neutral-900 border-b" id="contact">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 text-center">
        <h2 className="text-4xl font-bold">Contact</h2>

        <p className="pt-6 pb-6 text-base max-w-2xl text-center m-auto dark:text-neutral-400">
          Want to contact us? Choose an option below and well be happy to show
          you how we can transform her companys web experience.
        </p>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 pb-16 grid md:grid-cols-2 lg:grid-cols-2 gap-y-8 md:gap-x-8 md:gap-y-8 lg:gap-x-8 lg:gap-y-16">
        <div>
          ...
          <div className="flex items-center mt-2 space-x-2 text-dark-600 dark:text-neutral-400">
            ...
            <a href="mailto:darshilmodi8141@gmail.com">darshilmodi8141@gmail.com</a>
          </div>

          <div className="flex items-center mt-2 space-x-2 text-dark-600 dark:text-neutral-400">
            <PhoneIcon className="w-4 h-4" />
            <a href="tel:918141245978">+91 8141245978</a>
          </div>
        </div>
          ...
          {!isSubmitSuccessful && (
            <form onSubmit={handleSubmit(onSubmit)}>
              ...
              />
               <input
                type="hidden"
                value={process.env.NEXT_PUBLIC_FORM_REDIRECT_URL}  {...register("redirect")}
              />
              <input type="hidden" {...register("subject")} />
              <input type="hidden" value="Darshil" {...register("from_name")} />
              <input
                type="checkbox"
                id=""
                className="hidden"
