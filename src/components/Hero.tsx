      ...
      <div className="max-w-7xl mx-auto pt-20 pb-16 px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-2">
        <div className="pt-6 md:pt-32 justify-center text-center sm:justify-start sm:text-start">
          <h1 className="text-5xl font-bold">
            Welcome to <br />{" "}
            <span className="text-rose-500 font-extrabold">Our Design Studio!</span>
          </h1>
          <p className="pt-6 text-base w-auto sm:w-10/12 md:w-10/12 dark:text-neutral-400">
            Welcome to Studio, where innovation meets artistry. 
            Dive into our cutting-edge design studio and unlock endless possibilities. 
            Whether you&apos;re a seasoned creator or just starting your journey, our tools empower you to bring your visions to life.
          </p>
