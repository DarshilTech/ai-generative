...
const navigation = [
  ...
  { name: "Studio", href: "/design-studio", current: false },
        ...
        <>
            ...
            <div className="relative flex h-16 items-center justify-between">
              <div className="flex flex-1 items-center justify-start">
                    ...
                    {navigation.map((item) => (
                      ...
                      <Link
                        ...
                        className={classNames(
                          item.current
                            ? "text-neutral-900 dark:text-rose-500 "
                ...
                <div className="absolute inset-y-0 right-10 sm:right-0 flex items-center gap-2">
                  <Link
                    href="https://github.com/DarshilTech"
                    target="_blank"
          ...
          <Disclosure.Panel className="sm:hidden">
            <div className="space-y-1 px-4 min-h-screen border-t border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-900">
              ...
              <Link href="https://github.com/DarshilTech">
